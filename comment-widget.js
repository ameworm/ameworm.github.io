...
const s_formId = '1FAIpQLSeEskziyiEh9mINX_cDDWEGup3Qnhm1GYLcBQ-19_Vt1ZCdcQ'; // The Google Form
const s_nameId = '481190167'; // The Name field ID
const s_websiteId = '1214942070'; // The Website field ID
...
const s_filterReplacement = 'desu'; // Change what filtered words are censored with (**** is the default)
